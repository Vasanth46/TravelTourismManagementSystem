...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String text[]=new String[]{"JW MARRIOT HOTEL","MADARIN ORIENTAL HOTEL","FOUR SEASONS HOTEL","RADDISON BLUE HOTEL","CLASSIO HOTEL","THE BAY CLUB HOTEL","BREEZE BLOW HOTEL","THE TAJ HOTEL","HAPPY MORNING MOTEL","RIVERVIEW HOTEL"};
        try{
            for(int i=0;i<=9;i++){
